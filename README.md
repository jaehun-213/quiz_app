...
github 주소 : https://github.com/jaehun-213/quiz_app.git
...
### 홈 화면
![홈 화면](./스크린샷_및_데모_영상/홈화면.png)
![홈 화면](./스크린샷_및_데모_영상/홈화면_로그인_버전.png)

### 퀴즈 화면
![퀴즈 화면](./스크린샷_및_데모_영상/퀴즈_화면1.png)
![퀴즈 화면](./스크린샷_및_데모_영상/퀴즈_화면2.png)

### 데모 영상
![데모 영상](./스크린샷_및_데모_영상/데모영상1.mp4)
![데모 영상](./스크린샷_및_데모_영상/데모영상2.mp4)
해당 영상은 다운로드 된 파일 중 '스크린샷_및_데모_영상' 파일로 가셔서 데모영상 클릭하시면 영상 시청하실 수 있습니다.
